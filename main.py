...
stopuser = {}
token = "7544412916:AAGlyZ79at0He17mDEifeHPV2Vhi7XMyAqQ"
	...
	def my_function():
	  ...
	  "plan": "Free - Not Subscribed",
		...
		if BL == 'Free - Not Subscribed':	
			...
			contact_button = types.InlineKeyboardButton(text="ϟ Programmer - Kilwa", url="https://t.me/")
...
ϟ Programmer ~ @U_H_0_7 </b>''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
...
ϟ - Programmer • @U_H_0_7 ϟ</strong>''',reply_markup=keyboard)
...
def main(message):
	  ...
	  "timer": "none",
			...
			with open('data.json', 'w') as json_file:
				json.dump(existing_data, json_file, ensure_ascii=False, indent=4)	
			keyboard = types.InlineKeyboardMarkup()
			contact_button = types.InlineKeyboardButton(text="ϟ Programmer - Kilwa", url="https://t.me/U_H_0_7")
			keyboard.add(contact_button)
...
- Programmer ~ @U_H_0_7 - @P_3_Y1 </b>''',reply_markup=keyboard)
			return
		with open('data.json', 'r') as file:
			json_data = json.load(file)
